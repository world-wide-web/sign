...
请求支付["<center>提示课时不足<br>计算报名需补差价<br>请求支付</center>"]

支付完成["<center>支付完成</center>"]

报名成功["<center>扣除课时，展示报名成功页面</center>"]
```
...
3. 身份声明页
	...
	* 功能
		* 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzMjQ5NDcwNiwxNjc4NTU4NDc1LC05OD
