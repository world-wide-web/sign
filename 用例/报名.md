		...
		* 展现和管理使用系统的过程中所涉及过的所有报名项
			* 管理选项根据订单的状态将有所区别
				...
				* 已办理退课
					* 重新报名：重新生成订单，然后跳转到订单确认页
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDY3NjcyMzMsNTA4NTgwLC00Nzc0ND
cwOTYsLTIwNDY0NTI1MSwtMTk4MTk1Nzc5MywtNzg4MTIzNDkx
LC04Nzk1Njk3NDYsMTg2MjM2MjYyNiw3NzY0NTYzOTgsNzMzOD
