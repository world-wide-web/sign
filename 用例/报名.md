...
微调报名订单["<center>学员（Student）或家长（Guardian）<br>或教员（Instructor）微调报名订单的详情</center>"]
		...
		* 展现和管理使用系统的过程中所涉及过的所有报名项
			* 管理选项根据订单的状态将有所区别
				...
				* 已办理退课
					* 重新报名：重新生成订单，然后跳转到订单确认页
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzMTEzODk1LC0xOTgxOTU3NzkzLC03OD
gxMjM0OTEsLTg3OTU2OTc0NiwxODYyMzYyNjI2LDc3NjQ1NjM5
OCw3MzM4ODE2MjMsMjgzNDA4MTcsLTE1MTkzNDgxMjAsLTc1Nz
