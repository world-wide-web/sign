...
微调报名订单["<center>学员（Student）或家长（Guardian）或教员（Instructor）<br>微调报名订单的详情</center>"]
		...
		* 展现和管理使用系统的过程中所涉及过的所有报名项
			* 管理选项根据订单的状态将有所区别
				...
				* 已办理退课
					* 重新报名：重新生成订单，然后跳转到订单确认页
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwNzI3NTk2MywtNzg4MTIzNDkxLC04Nz
k1Njk3NDYsMTg2MjM2MjYyNiw3NzY0NTYzOTgsNzMzODgxNjIz
LDI4MzQwODE3LC0xNTE5MzQ4MTIwLC03NTczNzEwNjUsLTExNz
