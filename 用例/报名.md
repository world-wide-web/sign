		...
		* 展现和管理使用系统的过程中所涉及过的所有报名项
			* 管理选项根据订单的状态将有所区别
				...
				* 已办理退课
					* 重新报名：重新生成订单，然后跳转到订单确认页
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MDU2MzEzNDYsMTg2MjM2MjYyNiw3Nz
Y0NTYzOTgsNzMzODgxNjIzLDI4MzQwODE3LC0xNTE5MzQ4MTIw
LC03NTczNzEwNjUsLTExNzk0NzI3MDUsLTE0MTA4NDUxODUsLT
