		...
		* 展现和管理使用系统的过程中所涉及过的所有报名项
			* 管理选项根据订单的状态将有所区别
				...
				* 已办理退课
					* 重新报名：重新生成订单，然后跳转到订单确认页
<!--stackedit_data:
eyJoaXN0b3J5IjpbODY1MDc2MjQzLC0xOTQ2NzY3MjMzLDUwOD
U4MCwtNDc3NDQ3MDk2LC0yMDQ2NDUyNTEsLTE5ODE5NTc3OTMs
LTc4ODEyMzQ5MSwtODc5NTY5NzQ2LDE4NjIzNjI2MjYsNzc2ND
