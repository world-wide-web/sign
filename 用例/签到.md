...
2. 机构签到页
	...
	* 状态
		* a. 负责列表（默认态）
			...
			* 展示信息
				* 供选课程（Course）、课班（Class）、授课安排（Schedule）根据类型区别展现
				* 
		- b. 参课（Attendance）信息浏览
			* 功能
				* 快速浏览当前时间段内的参课（Attendance）信息，供点选触发代签到
...
4. 营销页
	...
	* 展示信息
		...
		* 授课安排（Schedule）信息，包括上课时间（Start Time）、上课地点（Location）、上课教员（Instructor）、上课时长（Last Time）
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTUyNzEyNjIsLTExMjgzMzE1MjQsLT
EwODczODM5OTEsODkxMjY0NjIwLDE3Mzk3NTE2MjUsLTIxNTEx
NzUwMiw3NjcyMDE3NywtMTk2ODUxNTQzOSwxOTIwNjc3MDc0LC
05MzI3ODgzNzAsLTYyNTQ2NzA3NSwxMjI1NjcwNTg1LDIwMjE4
NjQzNDIsMjAyMTg2NDM0MiwzNDk0NDk3NTgsMzQ5NDQ5NzU4XX
0=
-->