...
2. 机构签到页
	...
	* 状态
		* a. 负责列表（默认态）
			* 功能
				* 课程（Course）、课班（Class）、授课安排（Schedule）
...
4. 营销页
	...
	* 展示信息
		...
		* 授课安排（Schedule）信息，包括上课时间（Start Time）、上课地点（Location）、上课教员（Instructor）、上课时长（Last Time）
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODczODM5OTEsODkxMjY0NjIwLDE3Mz
k3NTE2MjUsLTIxNTExNzUwMiw3NjcyMDE3NywtMTk2ODUxNTQz
OSwxOTIwNjc3MDc0LC05MzI3ODgzNzAsLTYyNTQ2NzA3NSwxMj
I1NjcwNTg1LDIwMjE4NjQzNDIsMjAyMTg2NDM0MiwzNDk0NDk3
NTgsMzQ5NDQ5NzU4XX0=
-->